---
title: 'Core Overview'
description: 'Architecture overview of the C++ real-time engine powering OSOlogic PRO'
icon: 'microchip'
---

## Introduction

The **Core Engine** is the heart of OSOlogic PRO. Written in C++17, it runs as a single process with multiple threads on a Linux-based embedded system (Raspberry Pi / ARM). It is responsible for:
